"""
quanda/QARSBridge - QARS2 Rust核心桥接层
...
示例:
    >>> from quanda.QDRSBridge import QARSAccount, has_qars_support
    >>>
    >>> if has_qars_support():
    >>>     # 使用Rust高性能账户
...
if HAS_QARS:
    ...
    if not sys.flags.quiet:
        print(f"[QARS2] Rust core enabled (version {QARS_VERSION})")
        print(f"   Performance: 100x accounts, 10x backtest, 5-10x data")
