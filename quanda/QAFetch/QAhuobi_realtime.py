...
from quanda.QAUtil.QAParameter import (FREQUENCE, MARKET_TYPE)
from quanda.QAUtil.QALogs import (
    QA_util_log_info,
    QA_util_log_expection,
    QA_util_log_debug
)
from quanda.QAUtil.QASetting import (QA_Setting, DATABASE)
from quanda.QAUtil.QADate_Adv import (
    QA_util_str_to_Unix_timestamp,
    QA_util_datetime_to_Unix_timestamp,
    QA_util_timestamp_to_str
)
from quanda.QAUtil.QAcrypto import QA_util_find_missing_kline
...
"""
quanda 和 Huobi.pro 的 frequency 常量映射关系
"""
...
class QA_Fetch_Huobi(object):
    ...
    def add_subscription(
        ...
        # quanda 系统定义的时间跟火币网WebSocket 接口的有一点偏差 day 火币叫 1day，hour 火币定义为
        # 60min，需要查表映射转换。
...
if __name__ == "__main__":
    from quanda.QASU.save_huobi import (QA_SU_save_data_huobi_callback)
