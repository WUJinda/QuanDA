...
from quanda.QAFetch.base import _select_market_code, _select_index_code, _select_type, _select_bond_market_code
from quanda.QAUtil import (QA_Setting, QA_util_date_stamp, QA_util_code_tostr,
...
from quanda.QASetting.QALocalize import log_path
from quanda.QAUtil import Parallelism
...
def ping(ip, port=7709, type_='stock'):
    ...
    try:
        ...
        if isinstance(e, TypeError):
            print(e)
            print('Tushare内置的pytdx版本和quanda使用的pytdx 版本不同, 请重新安装pytdx以解决此问题')
...
def QA_fetch_get_option_all_contract_time_to_market():
    ...
    C:\work_new\quanda\quanda\QAFetch\QATdx.py:1468: SettingWithCopyWarning:
