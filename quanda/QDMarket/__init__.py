...
### 1. 使用市场预设获取合约参数
```python
from quanda.QDMarket import MARKET_PRESET
...
### 2. 创建订单对象
```python
from quanda.QDMarket import QA_Order
...
### 3. 管理持仓
```python
from quanda.QDMarket import QA_Position
...
### 4. 多标的持仓管理
```python
from quanda.QDMarket import QA_PMS
