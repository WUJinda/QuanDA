...
from quanda.QAData.base_datastruct import *
try:
    import peakutils
except:
...
try:
    ...
    print('PLEASE run "pip install quanda" before call quanda.QAAnalysis.QAAnalysis_signal modules')
    pass
...
def find_peak_vextors(price, return_ref=False, offest=0):
    ...
    but quanda incompatible scipy=>1.2
    ...
    # scipy=>1.2 but quanda incompatible scipy=>1.2
    y = filtfilt(b, a, xn)
