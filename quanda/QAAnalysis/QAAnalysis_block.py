...
from quanda.QAData.data_marketvalue import QA_data_marketvalue
from quanda.QAFetch.Fetcher import QA_quotation
from quanda.QAFetch.QAQuery import QA_fetch_stock_info
from quanda.QAFetch.QAQuery_Advance import (QA_fetch_stock_block_adv,
                                               QA_fetch_stock_day_adv,
                                               QA_fetch_stock_min_adv)
from quanda.QAFetch.QATdx import QA_fetch_get_stock_info
from quanda.QAFetch.QATdx_adv import QA_Tdx_Executor
from quanda.QAUtil.QADate_trade import QA_util_get_real_datelist
from quanda.QAUtil.QAParameter import (DATASOURCE, FREQUENCE, MARKET_TYPE,
                                          OUTPUT_FORMAT)
...
#from quanda.QAAnalysis.QAAnalysis_dataframe import QAAnalysis_stock
class QAAnalysis_block():
    ...
    def plot_index(self, methods='mv'):
        ...
        plt.title('quanda BLOCK ANA {}'.format(
