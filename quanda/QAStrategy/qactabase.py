...
from quanda.QAPubSub.consumer import subscriber, subscriber_routing, subscriber_topic
from quanda.QAPubSub.producer import publisher_routing, publisher_topic

import quanda as QA
from quanda.QAStrategy.util import QA_data_futuremin_resample
from quanda.QIFI.QifiAccount import ORDER_DIRECTION, QIFI_Account
from quanda.QAMarket.market_preset import MARKET_PRESET
from quanda.QAEngine.QAThreadEngine import QA_Thread
from quanda.QAUtil.QAParameter import MARKET_TYPE, RUNNING_ENVIRONMENT
...
class QAStrategyCtaBase():
    ...
    def debug(self):
        ...
        self.database = pymongo.MongoClient(mongo_ip).quanda
