...
import quanda as QA
from quanda.QAFetch.QATdx import QA_fetch_get_stock_list
from quanda.QAUtil import (DATABASE, QA_util_date_stamp,
...
def QA_SU_save_stock_min(client=DATABASE, ui_log=None, ui_progress=None):
    ...
    def __transform_jq_to_qa(df, code, type_):
        ...
        2. 与 quanda.QAFetch.QATdx.QA_fetch_get_stock_min 获取数据进行匹配，具体处理详见相应源码
