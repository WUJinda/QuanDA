...
def QA_SU_save_huobi_symbol(market=huobi_EXCHANGE, client=DATABASE,):
    ...
    if (len(raw_symbol_lists) > 0):
        # 保存到 quanda.cryptocurrency_list 数字资产列表，为了跨市场统一查询做数据汇总
