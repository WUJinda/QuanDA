...
# The MIT License (MIT)
#
from quanda.QAFetch.QAQuery import QA_fetch_stock_list
# from quanda.QASU import crawl_eastmoney as crawl_eastmoney_file
from quanda.QASU import save_tdx as stdx
from quanda.QASU import save_tdx_parallelism as stdx_parallelism
from quanda.QASU import save_tdx_file as tdx_file
from quanda.QASU import save_gm as sgm
from quanda.QASU import save_jq as sjq
from quanda.QASU import save_tushare as sts
from quanda.QASU import save_financialfiles
from quanda.QAUtil import DATABASE, print_used_time
import time


# from quanda.QASU import crawl_jrj_financial_reportdate as save_financial_calendar
# from quanda.QASU import crawl_jrj_stock_divyield as save_stock_divyield
...
def QA_SU_save_stock_list_tushare(client=DATABASE):
    ...
    from quanda.QASU.save_tushare import QA_SU_save_stock_list_to_stock_list
