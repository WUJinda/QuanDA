"""
quanda/QADataBridge - 跨语言零拷贝数据交换桥接层
...
示例:
    >>> from quanda.QDDataBridge import convert_pandas_to_polars, has_dataswap_support
    >>>
    ...
    >>>
    >>>     # 共享内存通信
    >>>     from quanda.QDDataBridge import SharedMemoryWriter
